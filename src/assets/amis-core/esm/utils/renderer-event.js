        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, runActions(listener.actions, listener.renderer, rendererEvent)];
                case 2:
                    _g.sent();
                    // 停止后续监听器执行
...
export { bindEvent, createRendererEvent, dispatchEvent, getRendererEventListeners };
