        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_t) {
                switch (_t.label) {
                    ...
                    case 1:
                        _t.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, env.fetcher((_c = action.args) === null || _c === void 0 ? void 0 : _c.api, omit__default["default"]((_d = action.args) !== null && _d !== void 0 ? _d : {}, ['api', 'options', 'messages']), (_f = (_e = action.args) === null || _e === void 0 ? void 0 : _e.options) !== null && _f !== void 0 ? _f : {})];
                    case 2:
                        result = _t.sent();
                        responseData = !helper.isEmpty(result.data) || result.ok
                            ...
                            : null;
                        // 记录请求返回的数据
                        event.setData(object.createObject(event.data, tslib.__assign(tslib.__assign({}, responseData), (_s = { responseData: responseData }, _s[action.outputVar || 'responseResult'] = tslib.__assign(tslib.__assign({}, responseData), { responseData: responseData, responseStatus: result.status, responseMsg: result.msg }), _s))));
                        if (!((_h = (_g = action.args) === null || _g === void 0 ? void 0 : _g.options) === null || _h === void 0 ? void 0 : _h.silent)) {
                            if (!result.ok) {
                                throw new errors.ServerError((_l = (_k = (_j = action.args) === null || _j === void 0 ? void 0 : _j.messages) === null || _k === void 0 ? void 0 : _k.failed) !== null && _l !== void 0 ? _l : result.msg, result);
                            }
                            else {
